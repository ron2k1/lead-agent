...
try {
    ...
    # releases it on exit. v0.9-final keeps lock semantics simple; v1.x adds
    # the runner-side cleanup contract per DESIGN.md s4.1.3.1.
    # Do NOT remove the lock here; that would defeat the point.
}
